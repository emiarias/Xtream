    ...
    <section className="container my-5">
      ...
      <Form>
        ...
        <Form.Group className="mb-3">
          ...
          <Form.Control
            ...
            {...register("anioEstreno", {
              ...
              maxLength: {
                value: 4,
                message: "El director debe tener como maximo 4 caracteres",
              },
              min: {
              value: 1800,
              message: "El año mínimo es el 1800",
              },
              max: {
              value: 2025,
              message: "El año máximo es el 2025",
              }
            })}
          />
          <Form.Text className="text-danger">
        ...
        <Form.Group className="mb-3">
          ...
          <Form.Control
            type="text"
            placeholder="Ej: https://www.movieposters.com/cdn/shop/products/ed4796ac6feff9d2a6115406f964c928_6b200bda-fe71-4900-ad7f-903cdda50dab_480x.progressive.jpg"
            {...register("imagen", {
